...
class Geocoder(object):
    ...
    def extract_from_graph(self):
        ...
        for way_id in self.osm.ways:
            ...
            if "addr:street" in way.tags.keys() and "addr:housenumber" in way.tags.keys():
                compact_name = self.compact(way.tags["addr:street"] + " " + way.tags["addr:housenumber"])
...
if __name__ == '__main__':
    ...
    map_file = './osmgeocode/sample.osm'
